...
async function main() {
  ...
  for (const game of completedGames) {
    ...
    try {
      ...
      // Per-player offensive stats — accumulate all categories before pushing
      // (a player can appear in multiple categories, e.g. QB in passing + rushing)
      const statsByPlayer = new Map(); // player_id → merged stat map
